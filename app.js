...
//In the joe.scope() invocation, "this" refers to the joe object. The method is a regular function, so it binds "this" to the object that calls it.

// 2. What is "this" when joe.scopeArrow() is invoked?
//In the joe.scopeArrow() invocation, "this" refers to the global object: window object in a browser environment. Arrow functions do not bind their own "this" value. They inherit it from the enclosing scope, in this case, is the global scope.

// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not have their own "this" binding, they inherit the "this" value from the enclosing scope at the time of their definition. This behavior makes arrow functions unsuitable for certain use cases, such as methods on objects or constructor functions, where the dynamic binding of "this" is desired. In the case of joe.scopeArrow(), since it's an arrow function, "this" refers to the global object, not the joe object.
